...
const config = {
  ...
  url: 'https://your-app.vercel.app', // Update this to your actual Vercel domain after deployment
  baseUrl: '/',
  organizationName: 'sameerkaleem',
  projectName: 'Physical-AI-And-Humanoid-Robotics-Claude-Code-CLI.github.io',
